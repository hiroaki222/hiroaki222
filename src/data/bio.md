...
# bio は段落配列、quote は pullout に使う一文。*En は言語切替 (EN 表示) 用。
bio:
  ...
  - "研究はほぼ未経験から始めました。入学直後から博士課程の先輩と組み、1 年ほどで 129 名分のクロスドメイン美的評価データセットを構築して arXiv プレプリント (第 2 著者) として公開。別テーマの AI コードレビュー研究では、筆頭著者として国内研究会 (JSAI SIG-AGI) で発表しました。"
...
bioEn:
  ...
  - "Research was new territory. Teaming up with a senior PhD student right after enrollment, I built a cross-domain aesthetic dataset rated by 129 participants within about a year and published it as an arXiv preprint (second author). On a separate line of work, comparing orchestration strategies for AI code review, I presented as first author at a domestic workshop (JSAI SIG-AGI)."
...
# 最終段落 (もう一方のサイトへの相互誘導) はレイアウト別。
# f1 (h-takahara.com) → hiroaki222.com へ / liquid (hiroaki222.com) → h-takahara.com へ。
bioOutro:
  f1: "エンジニアリングに寄せた詳細 (スキルの内訳や各プロダクトの中身) は、もう一つのポートフォリオ [hiroaki222.com](https://hiroaki222.com) にまとめています。"
  f1En: "For the engineering side (a full skill breakdown and each product in detail), see my other portfolio: [hiroaki222.com](https://hiroaki222.com)."
  liquid: "研究者としての横顔や経歴の全体像は、もう一つのポートフォリオ [h-takahara.com](https://h-takahara.com) にまとめています。"
  liquidEn: "For the researcher side and the full picture of my background, see my other portfolio: [h-takahara.com](https://h-takahara.com)."
# 本文横の写真 (f1.com の Biography 風、キャプション無し)
photo: /bio-photo.jpg
quote: "Laziness: the quality that makes you go to great effort to reduce overall energy expenditure."
quoteEn: "Laziness: the quality that makes you go to great effort to reduce overall energy expenditure."
quoteBy: 'Larry Wall, creator of Perl — "Laziness, Impatience, and Hubris"'
---
