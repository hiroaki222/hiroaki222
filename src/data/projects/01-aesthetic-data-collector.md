...
description: "研究データ収集のための Web アノテーション基盤を単独で設計・実装. 142 名の評定者から美術・ファッション・風景 3 ドメイン交互提示で約 9.8 万件の美的評価 (7 件法 + 9 種の美的感情) を収集し, このデータがクロスドメイン PIAA データセット XPASS-Vis (arXiv) の元になった. Next.js 15 / React 19 / Supabase / 日英対応. AI コーディング支援なしで手書きした最後のプロジェクト."
